...
def test_create(client, auth, app):
    """ Test create view
        ...
        GET request renders and returns a 200 OK status
        POST request inserts the new post data into the database.
...
def test_update(client, auth, app):
    """ Test update view
        ...
        GET request renders and returns a 200 OK status
        POST request modifies the existing data 
        Error message on invalid data
    """
    auth.login()
...
def test_create_update_validate(client, auth, path):
    """ Test create view only POSTs valid post - with title """
    auth.login()
...
def test_delete(client, auth, app):
    """ Test delete view
        ...
        Redirects to the index URL and the post should no longer exist in the
        database
    """
    auth.login()
